...
from btc_terminal.application import trades as _trade_calculations
...
# Public compatibility names now point at persistence-independent calculations.
DEFAULT_FEE_RATE = _trade_calculations.DEFAULT_FEE_RATE
calculate_sell_advice = _trade_calculations.calculate_sell_advice
calculate_okx_fifo_statistics = (
    _trade_calculations.calculate_okx_fifo_statistics
)
add_okx_order_profit_estimates = (
    _trade_calculations.add_okx_order_profit_estimates
)
...
_normalize_zone = _trade_calculations.normalize_zone
_distance_to_zone_pct = _trade_calculations.distance_to_zone_pct
classify_order_strategy = _trade_calculations.classify_order_strategy
